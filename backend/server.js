...
app.post("/send-email", (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "hotmail", // <-- A MUDANÇA ESTÁ AQUI
    auth: {
      user: process.env.EMAIL_USER, // Já vai pegar seu e-mail do Hotmail do .env
      pass: process.env.EMAIL_PASS, // Já vai pegar sua senha de app da Microsoft do .env
    },
    tls: {
      rejectUnauthorized: false, // MANTENHA ISSO!
    },
  });
