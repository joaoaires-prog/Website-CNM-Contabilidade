      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-blue-100 leading-relaxed">Mais de Duas Décadas Construindo Histórias de Sucesso</p>
            <p className="text-sm text-blue-200">
              Escritório de contabilidade especializado em soluções empresariais completas.
            </p>
          </div>
        ...
        <div className="border-t border-blue-700 mt-12 pt-8 text-center">
          <p className="text-blue-200">© 2025 CNM Contabilidade. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
